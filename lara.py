"""     I WOULD LIKE TO SAY THANKS TO 
       ...
       LAUNCH DATE: SATURDAY, 18 2019

     MEET MY SMALL BOT AVAILABLE ON TERMUX

  IF YOU NEED TO INSTALL IT FOLLOW THE                                                 COMMANDS GIVEN BELOW:

1. pkg update && pkg upgrade
                                                                                 #use apt instead of pkg if it is not work
                                                    
2. pkg install git
3. git clone https://github.com/ady08/lara.py.git
4. cd
5. ls
6. cd lara.py
...
class bc:
    ...
    bold="\033[1m"
    yellow="\033[33m"
print(bc.lightcyan+'Welcome To The Termux.'+bc.end)
logo ="""
|  ___|_ _  ___ ___| |__   ___   ___ | | __
| |_ / _` |/ __/ _ \ '_ \ / _ \ / _ \| |/ /
|  _| (_| | (_|  __/ |_) | (_) | (_) |   <
|_|  \__,_|\___\___|_.__/ \___/ \___/|_|\_\                                '''
print(bc.red+logo+bc.end)
print(bc.yellow+'Logrithm Artificial Regulated Assistance'+bc.end)
print("\n#######################")
print('##\n## Author : '+bc.red+'Nicoleus Sitorus'+bc.end)
print("##\n#######################")
user_name = str(input('\nWhat Should I call you:\t'))
if type(user_name) == str:
    print('\nHye! '+bc.green+user_name+bc.end+' Nice to meet you.')
print('\nToday Date and Time is:' ,datetime.datetime.now())
print('\nWhat Can I do for you\n\nHere are some keywords::->'+bc.blue+'Enter serial No. only.'+bc.end)
print(bc.yellow+'\n\n1.Add\n2.Sub\n3.Multi\n4.Division\n5.Area\n6.Trigonometry\n7.Square root\n8.Cube root\n9.Log\n10.Guess Games with LARA\n11.Cricket with LARA\n12.Rock, Paper, Scissor '+bc.end)
user_task = str(input('\nEnter Your Task: '))
if user_task == '1':
    ...
    while game_time!=0:
        ...
        if player_choice=="r" and computer_choice=="s":
            ...
            print("You Lose!")"""     I WOULD LIKE TO SAY THANKS TO 
                   InvBoy
                    AND
                Krysto Foxik 🐥
                FOR TESTING IT
...
2. pkg install git
3. git clone https://github.com/ZedRishu/lara.py.git
4. cd
5. ls
6. cd lara.py
7. pkg install python
...
print('\nEnd of Program!! Run me again',user_name,'by command '+bc.yellow+'python lara.py'+bc.end)
